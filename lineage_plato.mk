...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="plato_global-user 14 UP1A.230905.011 V816.0.9.0.ULQMIXM release-keys" \
    TARGET_DEVICE=$(PRODUCT_SYSTEM_DEVICE) \
    TARGET_PRODUCT=$(PRODUCT_SYSTEM_NAME)

BUILD_FINGERPRINT := Xiaomi/plato_global/plato:14/UP1A.230905.011/V816.0.9.0.ULQMIXM:user/release-keys
